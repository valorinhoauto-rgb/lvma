...
const CURATED_TARGETS_5 = [
  ...
  'LESTE', 'LIVRO', 'LUGAR', 'MAGIA', 'MALAS', 'MANHA', 'MESA', 'MINHA', 'MONTE', 'MUNDO',
...
const CURATED_TARGETS_6 = [
  ...
  'BATATA', 'BEIJOS', 'BELEZA', 'BONECA', 'BOSQUE', 'BRASIL', 'BRILHO', 'CABELO',
  'CAMISA', 'CANETA', 'CANHAO', 'CIDADE', 'COELHO', 'COLHER', 'COMIDA', 'COROAS',
  'CRISTO', 'DIRETO', 'ESCOLA', 'ESPADA', 'ESTUDO', 'FRANGO', 'FRUTAS', 'FOGUETE',
  'GAVETA', 'HOMENS', 'JARDIM', 'LIVROS', 'MACACO', 'MENINO', 'MESTRE', 'MUSEUS',
...
const CURATED_TARGETS_7 = [
  ...
  'FORMIGA', 'FUTEBOL', 'GALINHA', 'GARRAFA', 'GIRAFAS', 'GORILAS', 'GRAVATA', 'GATINHO',
  'IMAGENS', 'INVERNO', 'JACAREI', 'JANELAS', 'JARDINS', 'LAGARTO', 'LAMPADA', 'MADEIRA',
  'MAQUINA', 'MARTELO', 'MENINAS', 'MERCADO', 'MILITAR', 'MINERIO', 'MISTURA', 'MOCHILA',
  'MORCEGO', 'NAVALHA', 'PALACIO', 'PALAVRA', 'PALHACO', 'PANELAS', 'PARQUES', 'PESCOCO',
  'PIMENTA', 'PINGUIM', 'PINTURA', 'PIRATAS', 'PISTOLA', 'POLICIA', 'QUADROS', 'REMEDIO',
  'REPRESA', 'SAPATOS', 'SORVETE', 'SOLDADO', 'TESOURA', 'TORRADA', 'TUBARAO', 'VACINAS',
  'VALENTE', 'VEICULO', 'VESTIDO', 'VIAGENS', 'VIOLETA'
